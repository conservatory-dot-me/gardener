    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheduled_run_frequency', models.FloatField(blank=True, choices=[(0.04167, 'Hourly'), (0.125, '3-Hourly'), (1.0, 'Daily'), (7.0, 'Weekly'), (30.0, 'Monthly')], default=1.0, null=True)),
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='device.Device')),
            ],
            options={
                'ordering': ('gpio_export_num',),
            },
            bases=(models.Model, gardener.device.models.Gpio),
        ),
        migrations.CreateModel(
            name='ScheduledRun',
            fields=[
